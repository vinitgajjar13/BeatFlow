        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.favorite_rounded, color: Theme.of(context).iconTheme.color, size: 32).animate().scale(delay: 300.ms),
                  const SizedBox(width: 24),
                  Icon(Icons.more_horiz_rounded, color: Theme.of(context).iconTheme.color, size: 32).animate().scale(delay: 400.ms),
                  const Spacer(),
                  ClipRRect(
                  ...
                  ).animate().scale(delay: 500.ms, begin: const Offset(0, 0), end: const Offset(1, 1), curve: Curves.easeOutBack),
                ],
              ),
            ),
          ),
